...
if(1<a){var c=a-1;b.push("//www.gstatic.com/eureka/clank/"+a+"/cast_sender.js");b.push("//www.gstatic.com/eureka/clank/"+c+"/cast_sender.js")}return b},q7=function(){var a=aZa();
a&&a(!1,"No cast extension found")},r7=function(){if(eZa){var a=2,b=aZa(),c=function(){a--;
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;bZa("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",q7,c)}},fZa=function(){r7();
var a=dZa();a.push("//www.gstatic.com/eureka/clank/cast_sender.js");p7(a)},hZa=function(){r7();
var a=dZa();a.push.apply(a,g.u(gZa.map(cZa)));a.push("//www.gstatic.com/eureka/clank/cast_sender.js");p7(a)},iZa=function(){this.i=s7();
...
a.Qf&&(c=null);var d=(0,g.Ra)(a.UY,a);c||(c=new g.Al("//www.google.com/images/cleardot.gif"),W6(c));tZa(c.toString(),1E4,d)}else z7(2);KZa(a,b)},KZa=function(a,b){a.i=0;
